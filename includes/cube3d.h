...
/*   Updated: 2021/05/03 21:47:01 by jinspark         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		draw_letter_font1(t_mlx *mlx, double l_s, double r_s, char c);
...
void		draw_number(t_mlx *mlx, t_info *info, int num, double r_s);
void		draw_all_hud_numbers(t_mlx *mlx, t_info *info);
int			heart_color(t_mlx *mlx, int row, int line);
void		draw_one_heart(t_mlx *mlx, t_pars *par, t_info *info, double r_s);
...
void		drawing_swf(t_mlx *mlx, t_texture *te, int i, unsigned int p_w);
...
int			x_ray_find_len_wall(t_mlx *mlx, double a, double x, double y);
int			y_ray_find_len_wall(t_mlx *mlx, double a, double x, double y);
...
int			x_ray_shooting(t_mlx *mlx, t_rcast *cam, double angle, double l);
int			y_ray_shooting(t_mlx *mlx, t_rcast *cam, double angle, double l);
void		save_image_as_bmp(t_mlx *mlx);
void		fill_bmp_with_data_img(t_mlx *mlx, char *img_str, int i, int p);
int			fill_bmp_header_info(t_mlx *mlx, char *img_str, int i, int s);
...
void		walls_check_actual(t_pars *par, int i, int *actual, int *prev);
void		check_spaces_actual(t_pars *par, int i, int *actual, int *prev);
void		check_spaces_previous(t_pars *par, int i, int *actual, int *prev);
...
double		nb_pixel_wall(t_mlx *mlx, t_rcast *cam, t_texture *te, double a);
...
void		find_sprites(t_mlx *m, t_sprites *s, double x, double y, double a);
...
int			x_ray_find_wall(t_mlx *mlx, double angle, double x_len, double y);
...
int			y_ray_find_wall(t_mlx *mlx, double angle, double x_len, double y);
